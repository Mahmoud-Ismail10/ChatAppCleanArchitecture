...
{
    public class PinOrUnpinChatValidator : AbstractValidator<PinOrUnpinChatCommand>
    {
        #region Fields
        ...
        #region Constructors
        public PinOrUnpinChatValidator(IStringLocalizer<SharedResources> stringLocalizer)
        {
